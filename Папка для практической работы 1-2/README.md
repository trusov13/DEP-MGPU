...
### Данные и результаты
- [задание_1_peзультат.csv](./задание_1_peзультат.csv) - результаты выполнения задания 1
- [задание_2_peзультат.csv](./задание_2_peзультат.csv) - результаты выполнения задания 2  
- [задание_3_peзультат.csv](./задание_3_peзультат.csv) - результаты выполнения задания 3
